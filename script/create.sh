...
a
personal.unlockAccount(eth.accounts[4])
a
personal.unlockAccount(eth.accounts[5])
a
personal.unlockAccount(eth.accounts[6])
a
personal.unlockAccount(eth.accounts[7])
a
personal.unlockAccount(eth.accounts[8])
a
personal.unlockAccount(eth.accounts[9])
a

eth.sendTransaction({value: web3.toWei(1, 'ether'), gasPrice: 1, from:eth.accounts[0], to:eth.accounts[2]})
eth.sendTransaction({value: web3.toWei(1, 'ether'), gasPrice: 1, from:eth.accounts[0], to:eth.accounts[1]})
eth.sendTransaction({value: web3.toWei(1, 'ether'), gasPrice: 1, from:eth.accounts[0], to:eth.accounts[9]})
eth.sendTransaction({value: web3.toWei(1, 'ether'), gasPrice: 1, from:eth.accounts[0], to:eth.accounts[8]})
eth.sendTransaction({value: web3.toWei(1, 'ether'), gasPrice: 1, from:eth.accounts[0], to:eth.accounts[7]})
eth.sendTransaction({value: web3.toWei(1, 'ether'), gasPrice: 1, from:eth.accounts[0], to:eth.accounts[6]})
eth.sendTransaction({value: web3.toWei(1, 'ether'), gasPrice: 1, from:eth.accounts[0], to:eth.accounts[5]})
eth.sendTransaction({value: web3.toWei(1, 'ether'), gasPrice: 1, from:eth.accounts[0], to:eth.accounts[4]})
eth.sendTransaction({value: web3.toWei(1, 'ether'), gasPrice: 1, from:eth.accounts[0], to:eth.accounts[3]})
